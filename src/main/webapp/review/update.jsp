...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <DIV style='width: 100%;'>
    ...
    <FORM name='frm' method='POST' action='./update.do'
      ...
      <div class="form-group">   
        <div class="col-md-12">
          <textarea class="form-control" name='review_content' id='review_content' rows='10' placeholder="내용">${reviewVO.review_content }</textarea>
        </div>
      </div>
      ...
      <div class="form-group">   
        <div class="col-md-12">
          <input type='text' class="form-control" name='review_word'  value='${reviewVO.review_word }' placeholder="검색어" style='width: 90%;'>
        </div>
      </div>
