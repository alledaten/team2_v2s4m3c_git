...
<jsp:include page="/menu/top.jsp" flush='false' />
  <DIV class="title_line">
    『${answerVO.answer_no}』 이미지 변경 및 삭제
  </DIV>
  ...
  <DIV style='width: 100%;'>
    ...
    <input type='hidden' name='answer_no' id='answer_no' value='${param.answer_no }'>

        <IMG src="./storage/main_images/${file1 }" style="width: 50%; margin-bottom: 10px;">
        
        <div class="form-group">   
          <div class="col-md-12">
            <input type='password' class="form-control" name='answer_passwd'  value='1234' placeholder="패스워드" style='width: 20%;'>
          </div>
        </div>
        
        <button type="submit" class="btn btn-info">이미지 삭제</button>
        <button type="button" 
                    onclick="location.href='./read.do?answer_no=${param.answer_no}'" 
