...
<script type="text/javascript">
  $(function(){
    ...
    $('#address_send').on('click', send); // 나의 배송 주소록 등록  
  });
...
<body>
  ...
  <FORM name='frm' method='POST' action='../address/create.do' class="form-horizontal">
    <!-- FK communuity_no 지정 -->
    ...
    <div class="form-group">   
      <div class="col-md-12">
        <label>주소록 이름: </label>
        <input type='text' class="form-control" id='address_name' name='address_name' value='' placeholder="베프" required="required" style='width: 30%;'>
      </div>
    </div>
    ...
    <div class="form-group">   
      <div class="col-md-12">
        <label>이름: </label>
        <input type='text' class="form-control" id='address_member' name='address_member' value='' placeholder="홍길동" required="required" style='width: 30%;'>
      </div>
    </div>
    ...
    <div class="form-group">   
      <div class="col-md-12">
        <label>연락처: </label>
        <input type='text' class="form-control" id='address_phone' name='address_phone' value='' placeholder="010-0000-0000" required="required" style='width: 30%;'>
      </div>
    </div> 
    ...
    <div class="form-group">
      ...
      <div class="bottom_menu" style="padding-right: 10%;">
        <button type="button" id="address_send"  name="address_send" class="btn btn-primary">주소록 등록</button>
        <button type="button" class="btn btn-primary" data-dismiss="modal">등록 취소</button>
      </div>
