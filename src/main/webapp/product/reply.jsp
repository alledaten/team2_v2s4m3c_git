...
<script type="text/javascript">
  $(function() {
    CKEDITOR.replace('product_reply_content');  // <TEXTAREA>태그 id 값
  });
</script> 
</head> 
...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <ASIDE class='aside_left'>
    ${productgrpVO.productgrp_name } > ${productVO.product_name } > 답변 등록
  </ASIDE>
  ...
  <DIV style='width: 100%;'>
    <FORM name='frm' method='POST' action='./reply.do' class="form-horizontal"
      ...
      <div class="form-group">   
        <div class="col-md-12">
          <input type='text' class="form-control" name='product_name' value='' placeholder="제목" required="required" style='width: 80%;'>
        </div>
      </div>   
      
      <div class="form-group">   
        <div class="col-md-12">
          <textarea class="form-control" name='product_description' id='product_description' rows='6' placeholder="내용"></textarea>
        </div>
      </div>
      ...
      <div class="form-group">   
        <div class="col-md-12">
          <input type='text' class="form-control" name='product_word'  value='' placeholder="검색어" style='width: 90%;'>
        </div>
      </div>
