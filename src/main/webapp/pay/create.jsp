...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <FORM name='frm' method='POST' action='./create.do' class="form-horizontal">
    ...
    <div class="form-group">   
      <div class="col-md-12">
        <label>결제 금액: </label>
        <input type='text' class="form-control" name='pouduct_cost' value='' placeholder="10000" required="required" style='width: 30%;'>
      </div>
    </div>
    ...
    <div class="form-group">   
      <div class="col-md-12">
        <label>결제 방법: </label>
        <input type='text' class="form-control" name='pay_way' value='' placeholder="카드 결제" required="required" style='width: 80%;'>
      </div>
    </div>
      ...
      <div class="content_bottom_menu" style="padding-right: 20%;">
        ...
        <button type="button" onclick="location.href='./list.do'" class="btn btn-primary">결제 취소</button>
      </div>
