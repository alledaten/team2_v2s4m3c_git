...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <table class="pay">
    ...
    <tbody>
      ...
      <tr>
        <th scope="row" style="background: #EBAA5F;">결제 방법</th>
        <td style="text-align: left;">${payVO.pay_way }</td>
        <th scope="row" style="background: #EBAA5F;">결제 날짜</th>
      ...
      <tr>
        ...
        <td colspan="2" style="text-align: left;">${buyVO.pay_count } 개</td>
      </tr>
      <tr>
      ...
      <tr>
        <th scope="row" style="background: #B2FA5C;">배송비 </th>
        <td style="text-align: left;">${payVO.dev_cost } 원</td>
        <th scope="row" style="background: #ff4040;">총 결제 금액</th>
        <td colspan="2" style="text-align: left;">${payVO.pay_total } 원</td>
      </tr>
      <tr>
