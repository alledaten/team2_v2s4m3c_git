...
<script type="text/javascript">
  ...
  function delete_proc() {
    var product_attachfile_no = $('#btn_delete').attr('data-content'); // 삭제할 파일 번호 임시 저장
    var frm = $('#frm')
...
<jsp:include page="/menu/top.jsp" flush='false' />
  <form name='frm' id='frm' method='post' action='./delete.do'>
    ...
    <input type='hidden' name='rurl' id='rurl' value='./list_by_product_no.do'>
  ...
  <DIV class='title_line'>
    ${productVO.product_name } 첨부 파일
  </DIV>

  <ASIDE class='aside_left'>
    <A href='../product/read.do?product_no=${productVO.product_no }'>관련글</A> >
    <A href='./create.do?product_no=${productVO.product_no }&productgrp_no=${productVO.productgrp_no }'>첨부 파일 등록</A>
  </ASIDE>
