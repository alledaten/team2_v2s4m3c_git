...
CREATE TABLE attachfile(
        ...
        forum_contents_no                   NUMBER(10)         NULL ,
        fname                             VARCHAR2(100)         NOT NULL,
        fupname                      VARCHAR2(100)         NOT NULL,
        thumb                         VARCHAR2(100)         NULL ,
        fsize                                 NUMBER(10)         DEFAULT 0         NOT NULL,
        rdate                           DATE     NOT NULL,
  FOREIGN KEY (forum_contents_no) REFERENCES forum_contents (forum_contents_no)
);

COMMENT ON TABLE attachfile is '첨부파일';
COMMENT ON COLUMN attachfile.attachfileno is '첨부파일번호';
COMMENT ON COLUMN attachfile.forum_contents_no is '컨텐츠번호';
...
-- 1) 등록
INSERT INTO attachfile(attachfileno, forum_contents_no, fname, fupname, thumb, fsize, rdate)
...
SELECT attachfileno, forum_contents_no, fname, fupname, thumb, fsize, rdate
FROM attachfile
ORDER BY forum_contents_no DESC,  attachfileno ASC;
