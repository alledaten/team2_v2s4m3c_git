...
CREATE TABLE fattachfile(
        fattachfile_no                  NUMBER(10)         NOT NULL         PRIMARY KEY,
        fcontents_no                   NUMBER(10)         NULL ,
        fname                             VARCHAR2(100)         NOT NULL,
        fupname                      VARCHAR2(100)         NOT NULL,
        thumb                         VARCHAR2(100)         NULL ,
        fsize                                 NUMBER(10)         DEFAULT 0         NOT NULL,
        rdate                           DATE     NOT NULL,
  FOREIGN KEY (fcontents_no) REFERENCES fcontents (fcontents_no)
);

COMMENT ON TABLE fattachfile is '첨부파일';
COMMENT ON COLUMN fattachfile.fattachfile_no is '첨부파일번호';
COMMENT ON COLUMN fattachfile.fcontents_no is '컨텐츠번호';
COMMENT ON COLUMN fattachfile.fname is '원본 파일명';
COMMENT ON COLUMN fattachfile.fupname is '업로드 파일명';
COMMENT ON COLUMN fattachfile.thumb is 'Thumb 파일명';
COMMENT ON COLUMN fattachfile.fsize is '파일 사이즈';
COMMENT ON COLUMN fattachfile.rdate is '등록일';

DROP SEQUENCE fattachfile_seq;
CREATE SEQUENCE fattachfile_seq
  START WITH 1              -- 시작 번호
  INCREMENT BY 1          -- 증가값
...
-- 1) 등록
INSERT INTO fattachfile(fattachfile_no, fcontents_no, fname, fupname, thumb, fsize, rdate)
VALUES(fattachfile_seq.nextval, 1, 'samyang.jpg', 'samyang_1.jpg', 'samyang_t.jpg', 1000, sysdate);

INSERT INTO fattachfile(fattachfile_no, fcontents_no, fname, fupname, thumb, fsize, rdate)
VALUES(fattachfile_seq.nextval, 1, 'samyang2.jpg', 'samyang2_1.jpg', 'samyang2_t.jpg', 2000, sysdate);
             
INSERT INTO fattachfile(fattachfile_no, fcontents_no, fname, fupname, thumb, fsize, rdate)
VALUES(fattachfile_seq.nextval,  1, 'samyang3.jpg', 'samyang3_1.jpg', 'samyang3_t.jpg', 3000, sysdate);        

commit;

-- 2) 목록( fcontents_no 기준 내림 차순, fattachfile_no 기준 오르차순)
SELECT fattachfile_no, fcontents_no, fname, fupname, thumb, fsize, rdate
FROM fattachfile
ORDER BY fcontents_no DESC,  fattachfile_no ASC;
