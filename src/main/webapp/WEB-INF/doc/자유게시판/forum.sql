...
INSERT INTO forum(forum_no, boardgrp_no, forum_name, forum_seqno, forum_visible, forum_rdate, forum_cnt)
VALUES(forum_seq.nextval, 1, '어디갈까요', 1, 'Y', sysdate, 0);

INSERT INTO forum(forum_no, boardgrp_no, forum_name, forum_seqno, forum_visible, forum_rdate, forum_cnt)
VALUES(forum_seq.nextval, 2, '겨울엔 스키', 2, 'Y', sysdate, 0);

INSERT INTO forum(forum_no, boardgrp_no, forum_name, forum_seqno, forum_visible, forum_rdate, forum_cnt)
VALUES(forum_seq.nextval, 1, '하쿠바고류', 3, 'Y', sysdate, 0);
...
---------- ----------- ---------------------------------------------------------------------------------------------------- ----------- - -------- ----------
         1           1 어디갈까요                                                                                                     1 Y 20/11/03          0
         2           2 겨울엔 스키                                                                                                    2 Y 20/11/03          0
         3           1 하쿠바고류                                                                                                     3 Y 20/11/03          0
