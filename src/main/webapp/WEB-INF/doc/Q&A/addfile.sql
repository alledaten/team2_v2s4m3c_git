...
COMMENT ON COLUMN addfile.addfile_no is '첨부파일번호';
COMMENT ON COLUMN addfile.qna_no is '질문번호';
COMMENT ON COLUMN addfile.fname is '원본 파일명';
COMMENT ON COLUMN addfile.fupname is '업로드 파일명';
COMMENT ON COLUMN addfile.thumb is 'Thumb 파일명';
COMMENT ON COLUMN addfile.fsize is '파일 사이즈';
COMMENT ON COLUMN addfile.rdate is '등록일';
