...
CREATE TABLE reply(
        ...
        forum_contents_no                           NUMBER(10)    NOT     NULL ,
...
COMMENT ON COLUMN reply.forum_contents_no is '컨텐츠번호';
...
1) 등록
INSERT INTO reply(replyno, forum_contents_no, memberno, content, passwd, rdate)
...
INSERT INTO reply(replyno, forum_contents_no, memberno, content, passwd, rdate)
VALUES((SELECT NVL(MAX(replyno), 0) + 1 as replyno FROM reply),
             3, 1, '댓글3', '1234', sysdate);             

commit;

2) 전체 목록
SELECT replyno, forum_contents_no, memberno, content, passwd, rdate
FROM reply
