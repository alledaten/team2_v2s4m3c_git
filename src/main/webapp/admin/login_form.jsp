...
<DIV style='width: 80%; margin: 0px auto; background-color: #ffdddd;'>
  <FORM name='frm' method='POST' action='./login.do' class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        <input type='password' class="form-control" name='admin_passwd' id='admin_passwd' 
    ...
    <div class="form-group">
      <div class="col-md-offset-4 col-md-8">
        <button type="submit" class="btn btn-primary btn-md">관리자 로그인</button>
        <button type='button' onclick="location.href='./create.do'" class="btn btn-primary btn-md">관리자 등록</button>
