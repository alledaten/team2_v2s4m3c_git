...
public interface BoardgrpProcInter {
   ...
   * 목록
   * <xmp>
   * <select id="list_boardgrpno_asc" resultType="BoardgrpVO">
   * </xmp> 
   * @return 레코드 목록
   */
   ...
   * 목록
   * <xmp>
   * <select id="list_board_seqno_asc" resultType="BoardgrpVO">
   * </xmp> 
   * @return
   */
   ...
   * 출력 순서 상향
   * <xmp>
   * <update id="update_board_seqno_up" parameterType="int">
   * </xmp>
   * @param boardgrp_no
   * @return 처리된 레코드 갯수
   */
   ...
   * 출력 순서 하향
   * <xmp>
   * <update id="update_board_seqno_down" parameterType="int">
   * </xmp>
   * @param boardgrp_no
   * @return 처리된 레코드 갯수
   */
